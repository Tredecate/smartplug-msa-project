...
# App config
try:
    with open(Path("./default.config/default.analyzer_app_conf.yml"), 'r') as f:
...
# Log config
try:
    with open(Path("./default.config/default.analyzer_log_conf.yml"), 'r') as f:
...
# App config
try:
    with open(Path("/config/analyzer_app_conf.yml"), 'r') as f:
...
# Log config
try:
    with open(Path("/config/analyzer_log_conf.yml"), 'r') as f:
