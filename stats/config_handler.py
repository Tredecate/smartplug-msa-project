...
# App config
try:
    with open(Path("./default.config/default.stats_app_conf.yml"), 'r') as f:
...
# Log config
try:
    with open(Path("./default.config/default.stats_log_conf.yml"), 'r') as f:
...
# App config
try:
    with open(Path("/config/stats_app_conf.yml"), 'r') as f:
...
# Log config
try:
    with open(Path("/config/stats_log_conf.yml"), 'r') as f:
