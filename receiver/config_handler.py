...
# App config
try:
    with open(Path("./default.config/default.receiver_app_conf.yml"), 'r') as f:
...
# Log config
try:
    with open(Path("./default.config/default.receiver_log_conf.yml"), 'r') as f:
...
# App config
try:
    with open(Path("/config/receiver_app_conf.yml"), 'r') as f:
...
# Log config
try:
    with open(Path("/config/receiver_log_conf.yml"), 'r') as f:
